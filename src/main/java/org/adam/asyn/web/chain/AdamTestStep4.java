...
public class AdamTestStep4 implements IService<RequestMsg, DeferredResult<ResponseMsg<String>>> {

	private static final Log log = LogFactory.getLog(AdamTestStep4.class);

	private static final String STEP = "step 4 ";
