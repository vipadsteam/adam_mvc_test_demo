 ...
 * 
 */
package org.adam.asyn.web.chain.adam11;
 ...
 */
@Component
@ServiceType(WebMVCConstants.ADAM_TEST11)
@ServiceOrder(20)
@ServiceErrorCode(WebMVCConstants.ADAM_TEST_ERROR)
public class AdamTestStep11_2 implements IService<RequestMsg, DeferredResult<ResponseMsg<String>>> {
