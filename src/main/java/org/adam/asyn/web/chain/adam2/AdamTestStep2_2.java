...
public class AdamTestStep2_2 implements IService<RequestMsg, DeferredResult<ResponseMsg<String>>> {

	private static final Log log = LogFactory.getLog(AdamTestStep2_2.class);

	private static final String STEP = "step 2-2 ";
