...
public class AdamTestStep3_4 implements IService<RequestMsg, DeferredResult<ResponseMsg<String>>> {

	private static final Log log = LogFactory.getLog(AdamTestStep3_4.class);

	private static final String STEP = "step 3-4 ";
