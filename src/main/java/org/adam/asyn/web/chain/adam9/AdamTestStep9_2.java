...
import org.adam.asyn.web.service.client.HttpTestRetryClient;
...
public class AdamTestStep9_2 implements IService<RequestMsg, DeferredResult<ResponseMsg<String>>> {
	...
	@Autowired
	private HttpTestRetryClient httpTestClient;
	...
	public AbsCallbacker doService(RequestMsg income, ResultVo<DeferredResult<ResponseMsg<String>>> output) throws Exception {
		...
		TestRetryHttpFutureCallback callback = httpTestClient.call(url);
		return callback;
	}
